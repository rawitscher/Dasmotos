...
description: >-
  ...
  Pairs with any other skill as a review layer. Uses pre-mortem analysis,
  inversion thinking, and Socratic questioning to find blind spots, hidden
  assumptions, failure modes, and optimistic shortcuts. Invoke with
  /devils-advocate or ask Agent to run the devils-advocate subagent.
---
